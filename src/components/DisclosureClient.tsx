      ...
      {({ open }) => (
        <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
          ...
          <DisclosureButton
            ...
            className="px-2 py-1 ml-auto text-gray-500 rounded-md lg:hidden hover:text-primary focus:text-primary focus:bg-primary focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700"
          >
            <svg
            ...
            <>
              {navigation.map((item, index) => (
                <Link
                  key={index}
                  href={item.href}
                  className="w-full px-4 py-2 -ml-4 text-gray-500 rounded-md dark:text-gray-300 hover:text-primary focus:text-primary focus:bg-primary dark:focus:bg-gray-800 focus:outline-none"
                >
                  {item.text}
                </Link>
              ))}
